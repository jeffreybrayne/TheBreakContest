...
{if isset($_items)}
    ...
    {if $item.profile_quota_id == $_post.option}
            ...
            <div class="row">
                ...
                <div class="col9">
                    <div class="p5" style="padding-left:10px;">
                        ...
                        <span class="capital bold">{jrCore_lang module="jrYouTube" id="14" default="Category"}:</span> <span class="hl-4">{$item.youtube_category}</span><br>
                        {if isset($_post.option) && $_post.option == 'by_plays'}
                            <span class="capital bold">{jrCore_lang skin=$_conf.jrCore_active_skin id="51" default="plays"}:</span> <span class="hl-3">{$item.youtube_stream_count}</span><br>
                        {/if}
                        <span class="capital bold">{jrCore_lang module="jrYouTube" id="35" default="Duration"}:</span> <span class="hl-2">{$item.youtube_duration}</span><br>
                        <div class="p5">
