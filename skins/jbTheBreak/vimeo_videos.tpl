                ...
                <div class="container">
                    <div class="row">
                        <div class="col12 last">
                            <h2>{jrCore_lang skin=$_conf.jrCore_active_skin id="72" default="Vimeo"}</h2>
                            <div class="body_1">
                            ...
                            {/foreach}
                                ...
                                {jrCore_list module="jrVimeo" order_by=$order_by template="vimeo_videos_row.tpl" search="vimeo_title like `$_post._1`%" pagebreak="10" page=$_post.p}
                            </div>
                        </div>
                    </div>
                </div>
