...
{/if}
{assign var="page_title" value=$profile_name}
    ...
    <div class="row">
        <div class="col12 last">
            <div class="profile_menu">
                ...
                {else}
                	{jrProfile_menu template="profile_menu.tpl" profile_quota_id=$profile_quota_id profile_url=$profile_url order="jbArtistProfile"}
                {/if}
            </div>
        </div>
    </div>
