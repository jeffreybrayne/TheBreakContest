{* ROW TEMPLATE *}
{capture name="row_template" assign="site_blog_template"}
    {literal}
        {if isset($_items)}
...
{* EVENT LIST FUNCTION *}
{jrCore_list module="jrBlog" order_by="_created desc" search1="_profile_id = `$_conf.jbTheBreak_blog_profile`" search2="blog_category = blog" template=$site_blog_template pagebreak="1" page=$_post.p}
