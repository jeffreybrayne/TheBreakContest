                ...
                <div class="row">
                    ...
                    <div class=" col3 last">
                        <div class="nowrap float-right middle">
                            ...
                            <a href="{$jamroom_url}/stations/{$item.playlist_title_url}/autoplay=true">{jrCore_image image="button_player_play.png" alt=$plybttn_title title=$plybttn_title onmouseover="$(this).attr('src','`$jamroom_url`/skins/`$_conf.jrCore_active_skin`/img/button_player_play_hover.png');" onmouseout="$(this).attr('src','`$jamroom_url`/skins/`$_conf.jrCore_active_skin`/img/button_player_play.png');"}</a>
                ...
                <tr>
                    ...
                    <td class="body_4 p5 middle" style="width:25%;text-align:center;">
                        {if isset($info.prev_page) && $info.prev_page > 0}
                            <a onclick="jrLoad('#top_station_div','{$jamroom_url}/top_stations_list/p={$info.prev_page}');$('html, body').animate({ scrollTop: $('#topstation').offset().top });return false;"><span class="button-arrow-previous">&nbsp;</span></a>
                        {else}
                    ...
                    <td class="body_4 p5 middle" style="width:50%;text-align:center;border:1px solid #282828;">
                        ...
                        {else}
                            <form name="form" method="post" action="_self">
                                <select name="pagenum" class="form_select" style="width:60px;" onchange="var sel=this.form.pagenum.options[this.form.pagenum.selectedIndex].value;jrLoad('#top_station_div','{$jamroom_url}/top_stations_list/p=' +sel);;$('html, body').animate({ scrollTop: $('#topstation').offset().top });return false;">
                    ...
                    <td class="body_4 p5 middle" style="width:25%;text-align:center;">
                        {if isset($info.next_page) && $info.next_page > 1}
                            <a onclick="jrLoad('#top_station_div','{$jamroom_url}/top_stations_list/p={$info.next_page}');;$('html, body').animate({ scrollTop: $('#topstation').offset().top });return false;"><span class="button-arrow-next">&nbsp;</span></a>
                        {else}
