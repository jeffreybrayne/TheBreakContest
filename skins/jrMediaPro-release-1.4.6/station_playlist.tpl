            ...
            <div class="row">
                <div class="col4">
                    <div class="center p5 middle" style="margin:0 auto;">
                        <a href="{$jamroom_url}/{$item.profile_url}/{$murl}/{$item._item_id}/{$item.playlist_title_url}">{jrCore_module_function function="jrImage_display" module="jrProfile" type="profile_image" item_id=$item._profile_id size="large" crop="auto" alt=$item.playlist_title title=$item.playlist_title class="iloutline img_scale" style="width:227px;height:227px;"}</a>
                    </div>
                </div>
                <div class=" col8 last">
                    <div class="p5" style="margin:0 auto;">
