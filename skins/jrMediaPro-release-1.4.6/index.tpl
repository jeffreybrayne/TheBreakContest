                ...
                <div class="toggle-carousel">
                    ...
                    <section class="slider">
                        <div id="slider" class="flexslider">
                            <ul class="slides">
                                {if isset($_conf.jrMediaPro_slider_profile_ids) && $_conf.jrMediaPro_slider_profile_ids > 0}
                                    {jrCore_list module="jrProfile" search="_item_id in `$_conf.jrMediaPro_slider_profile_ids`" template="index_slider.tpl" limit="21"}
                                {elseif isset($_conf.jrMediaPro_require_images) && $_conf.jrMediaPro_require_images == 'on'}
                                    {jrCore_list module="jrProfile" order_by="profile_view_count numerical_desc" quota_id=$_conf.jrMediaPro_artist_quota search1="profile_active = 1" search2="profile_jrAudio_item_count > 0" template="index_slider.tpl" limit="21" require_image="profile_image"}
                                {else}
                                    {jrCore_list module="jrProfile" order_by="profile_view_count numerical_desc" quota_id=$_conf.jrMediaPro_artist_quota search1="profile_active = 1" search2="profile_jrAudio_item_count > 0" template="index_slider.tpl" limit="21"}
                                {/if}
                            </ul>
                        </div>
                        <div id="carousel" class="flexslider">
                            <ul class="slides">
                                {if isset($_conf.jrMediaPro_slider_profile_ids) && $_conf.jrMediaPro_slider_profile_ids > 0}
                                    {jrCore_list module="jrProfile" search="_item_id in `$_conf.jrMediaPro_slider_profile_ids`" template="index_slider_thumbs.tpl" limit="21"}
                                {elseif isset($_conf.jrMediaPro_require_images) && $_conf.jrMediaPro_require_images == 'on'}
                                    {jrCore_list module="jrProfile" order_by="profile_view_count numerical_desc" quota_id=$_conf.jrMediaPro_artist_quota search1="profile_active = 1" search2="profile_jrAudio_item_count > 0" template="index_slider_thumbs.tpl" limit="21" require_image="profile_image"}
                                {else}
                                    {jrCore_list module="jrProfile" order_by="profile_view_count numerical_desc" quota_id=$_conf.jrMediaPro_artist_quota search1="profile_active = 1" search2="profile_jrAudio_item_count > 0" template="index_slider_thumbs.tpl" limit="21"}
                                {/if}
                            </ul>
                        </div>
                    </section>
            ...
            <div class="col12 last">
                ...
                <div id="featured_artists" class="mb20">
                    ...
                    {if isset($_conf.jrMediaPro_profile_ids) && $_conf.jrMediaPro_profile_ids > 0}
                        {jrCore_list module="jrProfile" search="_item_id in `$_conf.jrMediaPro_profile_ids`" template="index_featured.tpl" pagebreak="1" page=$_post.p}
                    {elseif isset($_conf.jrMediaPro_require_images) && $_conf.jrMediaPro_require_images == 'on'}
