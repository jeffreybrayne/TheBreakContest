        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col6">
                    ...
                    <div id="main_logo">
                        {if jrCore_is_mobile_device()}
                            {jrCore_image id="mmt" skin="jrMediaPro" image="menu.png" alt="menu"}
                ...
                <div class="col6 last">
                    <div class="logo-ads">
                        {if $_conf.jrMediaPro_ads_off != 'on'}
                            ...
                            {elseif isset($_conf.jrMediaPro_top_ad) && strlen($_conf.jrMediaPro_top_ad) > 0}
                                {$_conf.jrMediaPro_top_ad}
                            {else}
