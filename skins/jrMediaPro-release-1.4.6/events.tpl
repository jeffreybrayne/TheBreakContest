                        ...
                        <div class="col12 last">
                            ...
                            <div class="body_1">
                                ...
                                {if isset($_conf.jrMediaPro_require_images) && $_conf.jrMediaPro_require_images == 'on'}
                                    {if isset($search)}
                                    {jrCore_list module="jrEvent" order_by=$order_by search="`$search`" tpl_dir="jrMediaPro" template="events_row.tpl" require_image="event_image" pagebreak=$_conf.jrMediaPro_default_events_pagebreak page=$_post.p}
                                    {else}
                                    {jrCore_list module="jrEvent" order_by=$order_by tpl_dir="jrMediaPro" template="events_row.tpl" require_image="event_image" pagebreak=$_conf.jrMediaPro_default_events_pagebreak page=$_post.p}
                                    {/if}
                                {else}
                                    {if isset($search)}
                                    {jrCore_list module="jrEvent" order_by=$order_by search="`$search`" tpl_dir="jrMediaPro" template="events_row.tpl" pagebreak=$_conf.jrMediaPro_default_events_pagebreak page=$_post.p}
                                    {else}
                                    {jrCore_list module="jrEvent" order_by=$order_by tpl_dir="jrMediaPro" template="events_row.tpl" pagebreak=$_conf.jrMediaPro_default_events_pagebreak page=$_post.p}
                                    {/if}
                                {/if}
                            </div>
                        </div>
