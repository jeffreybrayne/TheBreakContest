    ...
    <div id="footer_content">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col2">
                    <div id="footer_logo">
                        {jrCore_image image="logo.png" width="150" height="38" alt="TheBreak Skin &copy; {$smarty.now|date_format:"%Y"} The Jamroom Network" title="TheBreak Skin &copy; {$smarty.now|date_format:"%Y"} The Jamroom Network"}
                    </div>
                </div>
