<?php /* Smarty version Smarty-3.1.19, created on 2015-02-07 20:26:37
         compiled from "/home/twinli5/public_html/break/data/cache/jrCore/de0207e441789093b5f0ecf01e569cae.tpl" */ ?>
<?php /*%%SmartyHeaderCode:78218677454d674fde949a3-19230459%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b01076fa3dbca1f9f64412e1f736e78dfe01e05b' => 
    array (
      0 => '/home/twinli5/public_html/break/data/cache/jrCore/de0207e441789093b5f0ecf01e569cae.tpl',
      1 => 1423340797,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '78218677454d674fde949a3-19230459',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d674fe17aaa0_22190878',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d674fe17aaa0_22190878')) {function content_54d674fe17aaa0_22190878($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/twinli5/public_html/break/modules/jrCore/contrib/smarty/libs/plugins/modifier.date_format.php';
...
<?php $_tmp2=ob_get_clean();?><?php if (function_exists('smarty_function_jrCore_image')) { echo smarty_function_jrCore_image(array('image'=>"logo.png",'width'=>"150",'height'=>"38",'alt'=>"MediaPro Skin &copy; ".$_tmp1." The Jamroom Network",'title'=>"MediaPro Skin &copy; ".$_tmp2." The Jamroom Network"),$_smarty_tpl); } ?>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <div class="col3 last">
                    <div id="footer_sn">
                        ...
                        <?php if (strlen($_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_twitter_name'])>0) {?>
                            <a href="https://twitter.com/<?php echo $_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_twitter_name'];?>
" target="_blank"><?php if (function_exists('smarty_function_jrCore_image')) { echo smarty_function_jrCore_image(array('image'=>"sn-twitter.png",'width'=>"24",'height'=>"24",'class'=>"social-img",'alt'=>"twitter",'title'=>"Follow @".((string)$_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_twitter_name'])),$_smarty_tpl); } ?>
</a>
                        <?php }?>

                        <?php if (strlen($_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_facebook_name'])>0) {?>
                            <a href="https://facebook.com/<?php echo $_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_facebook_name'];?>
" target="_blank"><?php if (function_exists('smarty_function_jrCore_image')) { echo smarty_function_jrCore_image(array('image'=>"sn-facebook.png",'width'=>"24",'height'=>"24",'class'=>"social-img",'alt'=>"facebook",'title'=>"Like ".((string)$_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_facebook_name'])." on Facebook"),$_smarty_tpl); } ?>
</a>
                        <?php }?>

                        <?php if (strlen($_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_linkedin_name'])>0) {?>
                            <a href="https://linkedin.com/<?php echo $_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_linkedin_name'];?>
" target="_blank"><?php if (function_exists('smarty_function_jrCore_image')) { echo smarty_function_jrCore_image(array('image'=>"sn-linkedin.png",'width'=>"24",'height'=>"24",'class'=>"social-img",'alt'=>"linkedin",'title'=>"Link up with ".((string)$_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_linkedin_name'])." on LinkedIn"),$_smarty_tpl); } ?>
</a>
                        <?php }?>

                        <?php if (strlen($_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_google_name'])>0) {?>
                            <a href="https://google.com/<?php echo $_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_google_name'];?>
" target="_blank"><?php if (function_exists('smarty_function_jrCore_image')) { echo smarty_function_jrCore_image(array('image'=>"sn-google-plus.png",'width'=>"24",'height'=>"24",'class'=>"social-img",'alt'=>"google+",'title'=>"Follow ".((string)$_smarty_tpl->tpl_vars['_conf']->value['jrMediaPro_google_name'])." on Google+"),$_smarty_tpl); } ?>
</a>
                        <?php }?>
