<?php /* Smarty version Smarty-3.1.19, created on 2015-02-07 20:32:01
         compiled from "/home/twinli5/public_html/break/data/cache/jrCore/2f686ff111ac3a592cfb1cfd7c219978.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14413791554d67641640733-87119798%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a045b8e9b8fdcd5f0b18b1e16f2b99855a1d9e80' => 
    array (
      0 => '/home/twinli5/public_html/break/data/cache/jrCore/2f686ff111ac3a592cfb1cfd7c219978.tpl',
      1 => 1423341121,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14413791554d67641640733-87119798',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d676418a5f95_45207352',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d676418a5f95_45207352')) {function content_54d676418a5f95_45207352($_smarty_tpl) {?><?php if (function_exists('smarty_function_jrCore_include')) { echo smarty_function_jrCore_include(array('template'=>"meta.tpl"),$_smarty_tpl); } ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col6">
                    ...
                    <div id="main_logo">
                        <?php if (jrCore_is_mobile_device()) {?>
                            <?php if (function_exists('smarty_function_jrCore_image')) { echo smarty_function_jrCore_image(array('id'=>"mmt",'skin'=>"jbTheBreak",'image'=>"menu.png",'alt'=>"menu"),$_smarty_tpl); } ?>
...
"><?php if (function_exists('smarty_function_jrCore_image')) { echo smarty_function_jrCore_image(array('image'=>"logo.png",'class'=>"img_scale",'alt'=>$_smarty_tpl->tpl_vars['_conf']->value['jrCore_system_name'],'title'=>$_smarty_tpl->tpl_vars['_conf']->value['jrCore_system_name'],'style'=>"max-width:375px;max-height:80px;",'custom'=>"logo"),$_smarty_tpl); } ?>
                ...
                <div class="col6 last">
                    <div class="logo-ads">
                        <?php if ($_smarty_tpl->tpl_vars['_conf']->value['jbTheBreak_ads_off']!='on') {?>
                            <?php if (isset($_smarty_tpl->tpl_vars['_conf']->value['jbTheBreak_google_ads'])&&$_smarty_tpl->tpl_vars['_conf']->value['jbTheBreak_google_ads']=='on') {?>
                                <script type="text/javascript"><!--
                                    google_ad_client = "<?php echo $_smarty_tpl->tpl_vars['_conf']->value['jbTheBreak_google_id'];?>
";
                                    google_ad_width = 468;
                                    google_ad_height = 60;
                            ...
                            <?php } elseif (isset($_smarty_tpl->tpl_vars['_conf']->value['jbTheBreak_top_ad'])&&strlen($_smarty_tpl->tpl_vars['_conf']->value['jbTheBreak_top_ad'])>0) {?>
                                <?php echo $_smarty_tpl->tpl_vars['_conf']->value['jbTheBreak_top_ad'];?>
